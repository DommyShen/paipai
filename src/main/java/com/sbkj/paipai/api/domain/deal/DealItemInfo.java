...
public class DealItemInfo {
	...
	private String itemLocalCode;// string  商家自定义编码（商家编码） 
	...
	private String itemRetailPrice;// number  商品的原价 暂时不起作用 
	...
	private String itemDealCount;// number  购买的数量 
	private String account;// string  充值帐号（点卡类商品订单中才有意义） 
	private String itemFlag;// string   
	private String refundState;// string  退款状态，有退款时才有值 
	private String refundStateDesc;// string  退款状态描述，有退款时才有值 
	private String tradePropertymask;// string  自订单属性串，
	private String availableAction;// string   
	private String wanggouQuanId;// string  网购现金券ID 
	private String wanggouQuanAmt;// string  网购现金券金额 
